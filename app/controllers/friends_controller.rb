class FriendsController < ApplicationController
  ...
  def correct_user
    ...
    redirect_to friends_path, notice: "Sem autorização para esse tipo de ação " if @friend.nil?
  end
  ...
  private
    ...
    def friend_params
      params.require(:friend).permit(:primeiro_nome, :ultimo_nome, :email, :telefone, :twitter, :user_id)
    end
end
